    ...
    <div className="modal-backdrop">
      <div className="modal-content">
        ...
        <form onSubmit={handleSubmit} encType="multipart/form-data">
          ...
          <div className="form-group">
            <label>Brand</label>
            <input type="text" name="brand" list="brand-list" value={formData.brand} onChange={handleChange} autoComplete="off" />
          ...
          <div className="form-group">
            ...
            <input type="text" name="category" list="category-list" value={formData.category} onChange={handleChange} autoComplete="off" required />
          ...
          <div className="form-group">
            ...
            <select name="location" value={formData.location} onChange={handleChange} required disabled={isLocationLocked}>
